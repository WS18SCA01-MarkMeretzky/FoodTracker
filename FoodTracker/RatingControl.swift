...
@IBDesignable class RatingControl: UIStackView {
    ...
    private func setupButtons() {
        ...
        let filledStar: UIImage? = UIImage(named: "filledStar", in: bundle, compatibleWith: self.traitCollection);
        let emptyStar: UIImage? = UIImage(named:"emptyStar", in: bundle, compatibleWith: self.traitCollection);
        let highlightedStar: UIImage? = UIImage(named:"highlightedStar", in: bundle, compatibleWith: self.traitCollection);

        for index in 0 ..< starCount {
            // Create the button.
            let button: UIButton = UIButton();   //calls UIView.init(frame: .zero);
            ...
            // Add the button to the UIStackView.
